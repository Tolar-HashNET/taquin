...
describe('MetaMask', function () {
  ...
  describe('Send TOL from inside MetaMask using default gas', function () {
  ...
  describe('Send TOL from inside MetaMask using fast gas option', function () {
    it('starts a send transaction', async function () {
      await driver.clickElement(By.xpath(`//button[contains(text(), 'Send')]`))
      await driver.delay(regularDelayMs)
  ...
  describe('Send TOL from inside MetaMask using advanced gas modal', function () {
    it('starts a send transaction', async function () {
      await driver.clickElement(By.xpath(`//button[contains(text(), 'Send')]`))
      await driver.delay(regularDelayMs)
  ...
  describe('Send TOL from dapp using advanced gas controls', function () {
    let windowHandles
    let extension
    let popup
    let dapp
