...
async function start() {
  ...
  function displayCriticalError(container, err) {
    container.innerHTML =
      '<div class="critical-error">The Taquin app failed to load: please open and close Taquin again to restart.</div>';
...
function connectToAccountManager(connectionStream, cb) {
  ...
  setupWeb3Connection(mx.createStream("taquin-provider"));
}
