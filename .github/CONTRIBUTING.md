...
Taquin is a fork of Metamask, modified to interact with the Tolar HashNET blockchain.
If you're submitting code to Taquin, there are some simple things we'd appreciate you doing to help us stay organized!
...
There are also plenty of open issues we'd love help with.
...
- [ ] **Add to the CHANGELOG**: Help us keep track of all the moving pieces by adding an entry to the [`CHANGELOG.md`](https://github.com/Tolar-HashNET/taquin/blob/master/.github/CONTRIBUTING.md) with a link to your PR.
